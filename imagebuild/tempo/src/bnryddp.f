c      $Id$
	subroutine bnryddp(torb,fctn)

c  Model DD+ for main-sequence star binary pulsars (Wex 1997, 
c  astro-ph/9706086). Yet without the higher oder terms for the 
c  secular precession (om2dot,x2dot) 
